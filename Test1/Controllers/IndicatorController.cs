...
namespace IndInv.Controllers
{
	...
	public class IndicatorController : Controller
	{
		...
		public ActionResult viewPRAll(Int16 fiscalYear)
		{
		...
		public JsonResult newIndicatorAtPRdbl(Int16 fiscalYear, Int16 areaID, Int16 coeID, Int16 coeID2)
		{
			...
			return Json(new
			{
				...
				mapID = newMap.Map_ID,
				newAreaID = indicator.Area_ID,
				colorID = colorID,
				indicatorID2 = indicator2.Indicator_ID,
				mapID2 = newMap2.Map_ID,
				newAreaID2 = indicator2.Area_ID,
				colorID2 = colorID
